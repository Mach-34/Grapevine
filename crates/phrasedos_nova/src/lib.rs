...
pub const DEFAULT_WC_PATH: &str = "crates/phrasedos_nova/circom/artifacts/folded_js/folded.wasm";
pub const DEFAULT_R1CS_PATH: &str = "crates/phrasedos_nova/circom/artifacts/folded.r1cs";
pub const DEFAULT_PUBLIC_PARAMS_PATH: &str =
    "crates/phrasedos_nova/circom/artifacts/public_params.json";
