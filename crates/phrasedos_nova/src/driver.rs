...
//     // push third proof inputs
//     private_input = HashMap::new();
//     private_input.insert("secret".to_string(), json!(util::EMPTY_SECRET));
//     private_input.insert("usernames".to_string(), json!([usernames_felts[0], usernames_felts[1]]));
//     private_inputs.push(private_input);

//     // push fourth proof inputs
//     private_input = HashMap::new();
//     private_input.insert("secret".to_string(), json!(util::EMPTY_SECRET));
//     private_input.insert("usernames".to_string(), json!([util::ZERO, util::ZERO]));
//     private_inputs.push(private_input);
...
//     let start = Instant::now();
//     let res = recursive_snark.verify(&public_params, 4, &start_public_input, &z0_secondary);
//     println!(
